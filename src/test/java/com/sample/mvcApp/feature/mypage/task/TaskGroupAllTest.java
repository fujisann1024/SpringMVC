...
import com.sample.mvcApp.feature.mypage.task.adapter.web.controller.TaskGroupDetailControllerTest;
import com.sample.mvcApp.feature.mypage.task.application.service.TaskGroupDetailServiceTest;
import com.sample.mvcApp.feature.mypage.task.application.service.TaskGroupServiceTest;

@Suite
@SelectClasses({
  TaskGroupControllerTest.class,
  TaskGroupDetailControllerTest.class,
  TaskGroupServiceTest.class,
  TaskGroupDetailServiceTest.class,
